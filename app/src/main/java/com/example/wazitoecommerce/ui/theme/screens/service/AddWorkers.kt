...
@Composable
fun AddWorkers(navController:NavHostController){
    Column(
        modifier = Modifier
            .fillMaxSize()
        ...
        var workerServicesOffered by remember { mutableStateOf("") }
        var workerPricing by remember { mutableStateOf("") }
        var workerAvailability by remember { mutableStateOf("") }
        ...
        OutlinedTextField(
            value = workerServicesOffered,
            onValueChange = { workerServicesOffered = it },
            label = { Text(text = "Enter Services Offered *") },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
        )
        ...
        OutlinedTextField(
            value =workerPricing,
            onValueChange = { workerPricing = it },
            label = { Text(text = "Enter Your pricing *") },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
        )
        ...
        OutlinedTextField(
            ...
            onValueChange = { workerAvailability = it },
            label = { Text(text = "Your Availability *") },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Text)
        )
        ...
        ImagePicker(modifier,context, navController,
            workerName.trim(),
            workerEmail.trim(),
            workerPassword.trim(),
            workerServicesOffered.trim(),
            workerPricing.trim(),
            workerAvailability.trim(),
            )
...
fun AddWorkersPreview(){
    WazitoECommerceTheme {
        AddWorkers(navController = rememberNavController())
    }
}
